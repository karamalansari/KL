...
@Client.on_message(command(["ghnyhnyhn", f"nhhnyhh", "/xnjxizizix"]) & ~filters.edited)
def song(_, message):
...
@Client.on_message(
    command(["ksjdjdjd", f"/jdjdjdjdh", f"nhnynhn"]) & ~filters.edited
)
...
@Client.on_message(command(["lyric", f"jkuiklp"]))
