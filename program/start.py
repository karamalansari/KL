...
@Client.on_message(command("escanor") & filters.private & ~filters.edited)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/LDD7D"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_message(command(["rfgrfvrg", f"grgvrgr", f"rgrvrgr", f"cjfjvjfbfb"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/48c7a5396e8bc1132f9f3.jpg",
        caption=f"""Programmer [loner](https://t.me/LDD7D) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("lloner", url=f"https://t.me/LDD7D"),
            ],
            [
                InlineKeyboardButton(
                    "-loner .", url=f"https://t.me/ee3ww"
                ),
            ],
            [
...
@Client.on_message(command(["fgrtgv", "gvrgrfgv"]) & filters.group & ~filters.edited)
